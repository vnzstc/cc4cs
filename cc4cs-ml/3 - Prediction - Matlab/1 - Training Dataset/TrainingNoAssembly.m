...
%% Fine Tree
tic
[FineTreeModel, validationRMSET(i)] = FineTreeRegressionModelNoAssemby(Te);
timeTrain(i) = toc;
...
%% Linear Regression
tic
[LinearModel, validationRMSET(i)] = LinearRegressionModelNoAssembly(Te);
timeTrain(i) = toc;
...
%% Boosted Trees
tic
[BoostedTreesModel, validationRMSET(i)] = BoostedTreesRegressionModelNoAssembly(Te);
timeTrain(i) = toc;
...
%% Bagged Trees
tic
[BaggedTreesModel, validationRMSET(i)] = BaggedTreesRegressionModelNoAssembly(Te);
timeTrain(i) = toc;
...
%% Linear SVM
tic
[SVMModel, validationRMSET(i)] = SVMRegressionModelNoAssembly(Te);
timeTrain(i) = toc;
