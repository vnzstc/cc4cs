...
void prototype(uint32_t n_process, uint32_t n_resources, uint32_t available[n_resources], uint32_t allocated[n_process][n_resources], uint32_t max[n_process][n_resources]);
