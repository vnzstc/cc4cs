...
void prototype(uint8_t n_process, uint8_t n_resources, uint16_t available[n_resources], uint16_t allocated[n_process][n_resources], uint16_t max[n_process][n_resources]);
